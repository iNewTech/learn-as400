...
const paths = ['', ...chapters.map((chapter) => chapter.id), ...lessons.map((lesson) => `learn/${lesson.id}`), ...['sql', 'rpgle', 'files', 'compare', 'errors', 'codes'].map((section) => `guides/sql-file-ops/${section}`)];
writeFileSync(
